...
#    cd $tree_dir/$gene
#    raxmlHPC-PTHREADS-SSE3 -f a -x 123456 -p 123456  -s $align_dir/${gene}.mafft.phylip -m GTRGAMMA -N 1000 -n ${gene}.ex -k -T 4

    # modiry the tree
#    Rscript $workdir/scripts/tree_modify.R $tree_dir $gene
#done
