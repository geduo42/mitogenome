...
#    raxml-ng --all --msa $trim_dir/${gene}.fas --model GTR+I+G --tree pars{10} --bs-trees 200 --prefix gtrIG
    raxml-ng --bsconverge --bs-trees gtrIG.raxml.bootstraps --prefix grtIG.bs --bs-cutoff 0.01 --threads 10
...
do
    cd $tree_dir/$gene
#    raxml-ng --all --msa $trim_dir/${gene}.fas --model GTR+G --tree pars{10} --bs-trees 200 --prefix gtrG
    raxml-ng --bsconverge --bs-trees gtrG.raxml.bootstraps --prefix grtG.bs --bs-cutoff 0.01 --threads 10
...
do
    cd $tree_dir/$gene
#    raxml-ng --all --msa $trim_dir/${gene}.fas --model HKY+G --tree pars{10} --bs-trees 200 --prefix hkyG
    raxml-ng --bsconverge --bs-trees hkyG.raxml.bootstraps --prefix hkyG.bs --bs-cutoff 0.01 --threads 10
