...
aligroove_dir=$out_dir/aligroove.raxml
...
do
    ...
    raxmlHPC-PTHREADS-SSE3 -f a -x 123456 -p 123456  -s $trim_dir/${gene}.ape.fasta -m GTRGAMMA -N 1000 -n ${gene}.part.ex -k -T 12 -o MW373526 -q ${gene}.part
    ...
    Rscript $workdir/scripts/tree_modify.R $tree_dir $gene RAxML_bipartitionsBranchLabels.${gene}.part.ex
